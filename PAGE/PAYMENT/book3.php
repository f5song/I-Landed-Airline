    ...
    <div class="payment-confirmation-page">
      <div class="frame-for-descrip-customer">
        ...
        <div class="descrip-customer">
          ...
          <div class="frame-fill-name">
            <div class="info-paid">Panalee Chuckseeda</div>
          </div>
      ...
      <div class="detail-number-order">
        ...
        <div class="book-id">
          ...
          <div class="text-fake-id">1065298</div>
        </div>
      ...
      <div class="payment-three-ways" >
        ...
        <div class="div3" style="display: none;" id="3.1">
          ...
          <div class="eleven1">
            ...
            <img
              class="img-7-eleven-icon1"
              alt=""
              src="./public/img-7eleven1@2x.png"
            />
          </div>
          <div class="familymart4">
            <div class="text-familymart">FamilyMart</div>
            <img
              class="img-familymart-icon1"
              alt=""
              src="./public/img-familymart1@2x.png"
            />
          </div>
          <div class="tesco-lotus">
            <div class="text-tesco-lotus">Tesco Lotus</div>
            <img
              class="img-tesco-icon"
              alt=""
              src="./public/img-lotus@2x.png"
            />
          </div>
        </div>
        ...
        <div class="div3" id="2.1" style="display: none;" >
          ...
          <div class="krungth-bank">
            ...
            <img
              class="img-krungth-bank"
              alt=""
              src="./public/img-krungth-bank@2x.png"
            />
          </div>
          <div class="kasikorn-bank">
            <div class="text-kasikorn-bank1">ธนาคารกสิกรไทย</div>
            <img
              class="img-kasikorn-bank"
              alt=""
              src="./public/img-kasikorn-bank@2x.png"
            />
          </div>
          <div class="th-panit-bank">
            <div class="text-panit-bank1">ธนาคารไทยพาณิชย์</div>
            <img
              class="img-panit-bank1"
              alt=""
              src="./public/img-panit-bank1@2x.png"
            />
          </div>
        </div>
        ...
        <div class="div8" style="display: none;" id="1.1">
          ...
          <div class="descrip-price2">
            ...
            <img
              class="separate-line-icon2"
              alt=""
              src="./public/separate.svg"
            />
          </div>
          <div class="pic">
            ...
            <img
              class="img-master-card"
              alt=""
              src="./public/img-master-card@2x.png"
            />

            <img
              class="img-secure-icon"
              alt=""
              src="./public/img-secure@2x.png"
            />
      ...
      <div class="navbar">
        ...
        <div class="process-three-step">
          ...
          <img
            class="separate-line-icon3"
            alt=""
            src="./public/separate-line1.svg"
          />
