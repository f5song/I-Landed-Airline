                ...
                <div class="have2go-content">
                    <div class="placerow1">
                        <div class="place1">
                            ...
                            <div class="placetext"><p>หาดป่าตอง</p>
                                <p>ป่าตอง | ภูเก็ต | ประเทศไทย</p></div>
                        </div>
                        <div class="place2">
                            <div><img src="./img/mud.png" alt=""></div>
                            <div class="placetext"><p>มัสยิดกลางสงขลา</p>
                                <p>คลองแห | สงขลา | ประเทศไทย</p></div>
                        </div>
                        <div class="place3">
                            <div><img src="./img/ifpare.png" alt=""></div>
                            <div class="placetext"><p>ถนนคนเดินท่าแพ</p>
                                <p>ศรีภูมิ | เชียงใหม่ | ประเทศไทย</p></div>
                        </div>
                    </div>
                    <div class="placerow2">
                        <div class="place4">
                            <div><img src="./img/sky.png" alt=""></div>
                            <div class="placetext"><p>มหานคร สกายวอล์ค</p>
                                <p>บางรัก| กรุงเทพฯ | ประเทศไทย</p></div>
                        </div>
                        <div class="place5">
                            <div><img src="./img/temple.png" alt=""></div>
                            <div class="placetext"><p>วัดป่าภูก้อน</p>
                                <p>บ้านก้อง | อุดรธานี | ประเทศไทย</p></div>
                        </div>
                        <div class="place6">
                            <div><img src="./img/iconsiam.png" alt=""></div>
                            <div class="placetext"><p>ไอคอนสยาม</p>
                                <p>คลองสาน | กรุงเทพฯ | ประเทศไทย</p></div>
                        </div>
                    </div>
                    <div class="placerow3">
                        <div class="place7">
                            <div><img src="./img/he.png" alt=""></div>
                            <div class="placetext"><p>ทะเลหมอกฆูนุงซีลีปัต</p>
                                <p>อัยเยอร์เวง | ยะลา| ประเทศไทย</p></div>
                        </div>
                        <div class="place8">
                            <div><img src="./img/sirikit.png" alt=""></div>
                            <div class="placetext"><p>สวนพฤกษศาสตร์พระนางเจ้าสิริกิติ์</p>
                                <p>แม่ริม | เชียงใหม่ | ประเทศไทย</p></div>
                        </div>
                        <div class="place9">
                            <div><img src="./img/pp.png" alt=""></div>
                            <div class="placetext"><p>เกาะพีพี</p>
                                <p>หมู่เกาะ | ภูเก็ต | ประเทศไทย</p></div>
                        </div>
                    </div>
                </div>
            </div>
